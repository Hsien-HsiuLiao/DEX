...
debugger;
    ...
    depositEther: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            debugger;
            return exchangeInstance.depositEther({value: web3.toWei(amountEther, "Ether"), from: account, gas: 3000000});
    ...
    withdrawEther: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            return exchangeInstance.withdrawEther(web3.toWei(amountEther, "Ether"), {from: account, gas: 220000});
        }).then(function (txResult) {
            App.refreshBalanceExchange();
